        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-10 font-poppins'>
          ...
          <div className='md:pt-[6rem] md:pl-4 md:pr-8 grid text-justify'>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-3 md:hidden lg:grid gap-4 px-4 lg:pl-4 mt-4'>
              <img src={About1} title='photo-working-out' alt="photo-working-out" loading='lazy' className='object-fill h-[10rem] aspect-square mx-auto rounded border border-gray-400' />
              <img src={About2} title='photo-travelling' alt="photo-travelling" loading='lazy' className='object-fill h-[10rem] aspect-square mx-auto rounded border border-gray-400' />
              <img src={About3} title='photo-eating-out' alt="photo-eating-out" loading='lazy' className='col-span-2 sm:col-span-1 mx-auto object-scale h-[10rem] aspect-square rounded border border-gray-400' />
            </div>
          </div>
        </div>
      </div>
