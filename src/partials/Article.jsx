            ...
            <main className="grow mt-[8rem] px-4 pb-12">
                <div className="max-w-6xl px-4 text-white lg:grid lg:grid-cols-4 gap-8">
                    ...
                    <Link to='/blog' className="flex justify-center">
                        <button className="lg:hidden flex gap-2 mt-8 btn text-white bg-teal-500 hover:bg-orange-700 dark:hover:bg-transparent dark:hover:border dark:hover:border-teal-500 dark:hover:text-teal-500 shrink-0 transition duration-500 dark:duration-800">
