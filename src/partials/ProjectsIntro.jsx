            ...
            <article>
              <header>
                ...
                <div className="text-center md:text-left">
                  ...
                  <p className="text-xl text-gray-600 dark:text-gray-400 text-left">Check out some of the projects I have done/collaborated in the past. My experience is based on websites development, digital transformation projects and business consultancy.</p>
                </div>
              </header>
            </article>
          </div>
