        ...
        <div className='font-poppins max-w-3xl mx-auto'>
          ...
          <div className='grid grid-cols-6 gap-6 lg:gap-12 mt-8'>
            <div className='col-span-3 md:col-span-2 mx-auto'>
              <svg className="h-12 w-12 dark:text-white mx-auto"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className='col-span-3 md:col-span-2 mx-auto'>
              <svg className='dark:bg-white h-12 w-12 mx-auto' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M480 32l-64 368-223.3 80L0 400l19.6-94.8h82l-8 40.6L210 390.2l134.1-44.4 18.8-97.1H29.5l16-82h333.7l10.5-52.7H56.3l16.3-82H480z"/></svg>
